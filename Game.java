...
public class Game {
    ...
    public void createGameScreen(){
        ...
        mainTextPanel.setBounds(100, 100, 900, 600);
        mainTextPanel.setBackground(Color.black);
        con.add(mainTextPanel);
        narratorResponse1 = new JTextArea("");
        narratorResponse1.setBounds(100, 100, 900, 350);
        ...
        narratorResponse2.setBounds(100, 100, 900, 350);
        ...
        narratorResponse3.setBounds(100, 100, 900, 350);
        ...
        narratorResponse4.setBounds(100, 100, 900, 350);
        ...
        narratorResponse5.setBounds(100, 100, 900, 350);
        ...
        playerResponse1.setBounds(100, 100, 900, 350);
        ...
        playerResponse2.setBounds(100, 100, 900, 350);
        ...
        playerResponse3.setBounds(100, 100, 900, 350);
        ...
        playerResponse4.setBounds(100, 100, 900, 350);
        ...
        playerResponse5.setBounds(100, 100, 900, 350);
        ...
        narratorResponseDeath1.setBounds(100, 100, 900, 350);
        ...
        narratorResponseDeath2.setBounds(100, 100, 900, 350);
        ...
        narratorResponseDeath3.setBounds(100, 100, 900, 350);
        ...
        narratorResponseDeath4.setBounds(100, 100, 900, 350);
        ...
        narratorResponseDeath5.setBounds(100, 100, 900, 350);
...
//        choice4.setContentAreaFilled(false);  // Disable highlighting on press!!!
    ...
    public void foyer(){
        position = "foyer";
        resetScene();
        narratorResponse1.setText("Guard: Hey don't be stupid!\n\nThe guard fought back and hit you hard.\n(You receive 3 damage)");
        //playerHP = playerHP -3;
        playerHP -=3;
        hpLabelNumber.setText(""+playerHP);
        choice1.setText(">");
    ...
    public void houseEast(){
        position = "houseEast";
        resetScene();
        narratorResponse1.setText("You smack your head into the wall. You wake up to find yourself being eaten by the Grue. Your last concious thought is the determination to pay attention to your surroundings more.");
    ...
    public void fight(){
        position = "fight";
        resetScene();
        narratorResponse1.setText("Monter HP: " + monsterHP + "\n\nWhat do you do?");
